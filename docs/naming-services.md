...
| Service Name | Description                            |
|:-------------|:---------------------------------------|
| mon          | Monitoring (e.g. Grafana)              |
| logs         | Log server (e.g. Splunk, Grafana Loki) |
